...
using DictonaryHashTable;

Dictionary<int, Employee> employees = new Dictionary<int, Employee>();

employees.Add(100, new Employee() { FirstName = "Marcin", LastName = "Jamro", PhoneNumber = "000-000-000" });
employees.Add(200, new Employee() { FirstName = "Mary", LastName = "Fox", PhoneNumber = "111-111-111" });
employees.Add(300, new Employee() { FirstName = "John", LastName = "Smith", PhoneNumber = "222-222-222" });
